...
public class SPADEContext {
    ...
    */
    ...
    public void authorRunSpade() throws IOException {        
        FileWriter fstream;
        fstream = new FileWriter(new File(this.getPath(), "runSPADE.R").getAbsolutePath());
        ...
        out.write("LIBRARY_PATH=\"~/Research/cytof/SPADE/lib\"\n"
        + "NUM_THREADS <- 1\n"
